  ...
  deploy-rdp:
    ...
    - name: Connection Details
      run: |
        ...
        Write-Host "â•‘         ENIGMANO RDP ACCESS          â•‘" -ForegroundColor Cyan  
        Write-Host "â• â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•£" -ForegroundColor Cyan
        Write-Host "â•‘ Host: $env:TAILSCALE_IP              â•‘" -ForegroundColor White
        Write-Host "â•‘ Username: runneradmin                â•‘" -ForegroundColor White
        Write-Host "â•‘ Password: P@ssw0rd!                  â•‘" -ForegroundColor White
